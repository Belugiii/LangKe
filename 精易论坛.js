...
class Task {
    constructor(str) {
        ...
        this.ck = str;
        this.ckStatus = true;
        this.name,this.formhash,this.balance;
    }
    ...
    async init() {
        try {
            ...
            this.name = doc.querySelector(".vwmy.qq").childNodes[0].text;
            this.balance = doc.querySelector('.creditl.mtm.bbda.cl').childNodes[4].textContent
            if(!this.formhash){
                this.ckStatus = false;
                return
            }

 ...
 * 奥康皮鞋
 *
 * cron 0 0,7 * * *  yml2213_javascript_master/ak.js
 *
 * 7-27		签到，积分查询
 *
 * ========= 青龙--配置文件 =========
 ...
 */
 ...
 !(async () => {
     let ckArr = await checkEnv(ckStr, "aokang_data");
     await tips(ckArr);
 ...
 async function signin() {
     try {
         let url = {
             url: `${hostname}/myvip/Vip/SignIn/SignIn`,
             headers: {
                 "Host": host,
                 "ezr-cop-id": "33",
                 "ezr-vuid": ck[0],
  ...
  */
  async function jf() {
     try {
         let url = {
             url: `${hostname}/myvip/Vip/Bonus/GetMyBonusLogs?pageSize=10&pageIndex=1`,
             headers: {
                 "Host": host,
                 "ezr-cop-id": "33",
                 "ezr-vuid": ck[0],
         ...
         if (result?.Success == true) {
             DoubleLog(`查询:${result.Msg} 🎉,当前积分:${result.Result.BonusTotal} `);
             await wait(3);
         } else {
